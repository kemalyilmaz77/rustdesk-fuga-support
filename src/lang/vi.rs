...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới FugaDesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, FugaDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt FugaDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho FugaDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho FugaDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [FugaDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep FugaDesk background service", "Giữ dịch vụ FugaDesk chạy nền"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu FugaDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng FugaDesk với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ FugaDesk mở"),
        ...
        ("floating_window_tip", "Giữ FugaDesk trên cùng"),
